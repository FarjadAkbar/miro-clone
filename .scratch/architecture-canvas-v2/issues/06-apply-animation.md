...
**What to build:** When a Design plan applies, Nodes/Edges/Groups enter with short transitions instead of popping in.

**Blocked by:** 4

**Status:** done

- [x] Pure apply-enter seam (class names + action stagger delay)
